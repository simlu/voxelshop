...
public class MagicaVoxFormatFitToBBTest extends AbstractFormatTest {

    public MagicaVoxFormatFitToBBTest() {
        super("magica_vox" + File.separator + "fit_to_bb");
    }
    ...
    AbstractExporter initExporter(File file, Data data) throws IOException {
        return new MagicaVoxelExporter(file, data, new ProgressDialog(null), null, false);
    }
