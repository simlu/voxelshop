package com.vitco.app.layout.content.console;
...
import com.vitco.app.export.generic.ExportWorld;
...
public class ConsoleView extends ViewPrototype implements ConsoleViewInterface {
    ...
    public JComponent buildConsole(final FrameLinkagePrototype frame) {
        ...
        menuGenerator.buildMenuFromXML(menuPanel, "com/vitco/app/layout/content/console/toolbar.xml");
