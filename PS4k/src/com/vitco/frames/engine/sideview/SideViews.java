...
public class SideViews extends ViewPrototype implements SideViewsInterface {
    ...
    public JPanel createView(final int side) {
        ...
        // create the VPanel
        //VPanel panel = new VPanel(animationData, actionManager, langSelector, side, viewPanel, menuPanel);
        JPanel panel = sideViews[side].build();
        panel.setBorder(BorderFactory.createLineBorder(VitcoSettings.DEFAULT_BORDER_COLOR));
