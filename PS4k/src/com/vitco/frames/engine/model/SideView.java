...
/**
 * Can render an AnimationData and provides means to alter the data.
 */
public class SideView extends ViewPrototype implements SideViewInterface {
    ...
    public JPanel createView(final int side) {
        ...
        menuGenerator.buildMenuFromXML(menuPanel, "com/vitco/frames/engine/model/toolbar" + (side + 1) + ".xml");
        menuPanel.setBorder(
