...
public class VoxelDataTest {
    ...
    public void testAddDeleteVoxel() throws Exception {
        assert -1 == data.addVoxel(Color.RED, null, new int[]{0,0,0});
        int lid1 = data.createLayer("layer1");
        assert -1 == data.addVoxel(Color.RED, null, new int[]{0,0,0});
        data.selectLayer(lid1);
        int id1 = data.addVoxel(Color.RED, null, new int[]{0,0,0});
        assert id1 > -1;
        assert -1 == data.addVoxel(Color.RED, null, new int[]{0,0,0});
        ...
        data.undoV();
        assert data.getVoxel(id1).id == id1;
        assert data.addVoxel(Color.RED, null, new int[]{0,0,0}) == -1;
        data.selectLayer(lid2);
        int id2 = data.addVoxel(Color.RED, null, new int[]{0,0,0});
        assert id2 > -1;
        assert data.getVoxel(id2).id == id2;
        int id3 = data.addVoxel(Color.GREEN, null,  new int[]{5,0,0});
    ...
    public void testMoveVoxel() throws Exception {
        ...
        data.selectLayer(lid1);
        int id1 = data.addVoxel(Color.RED, null, new int[]{5,6,7});
        int id2 = data.addVoxel(Color.RED, null, new int[]{7,8,9});
    ...
    public void testMergeLayers() throws Exception {
        ...
        int lid2 = data.createLayer("layer2");
        data.selectLayer(lid1);
        int id1 = data.addVoxel(Color.RED, null, new int[] {1,1,1});
        int id2 = data.addVoxel(Color.GREEN, null, new int[] {1,1,2});
        data.selectLayer(lid2);
        int id3 = data.addVoxel(Color.ORANGE, null, new int[] {1,1,1});
    ...
    public void testGetVoxelSlice() throws Exception {
        ...
        data.addVoxel(Color.RED, null, new int[] {5,2,0});
        data.addVoxel(Color.RED, null, new int[] {4,-10,0});
        data.addVoxel(Color.RED, null, new int[] {4,-10,2});
    ...
    public void testMigrateSelection() throws Exception {
        ...
        data.selectLayer(lid1);
        int id1 = data.addVoxel(Color.BLACK, null, new int[]{1,2,3});
        int id2 = data.addVoxel(Color.GREEN, null, new int[]{1,2,4});
        data.selectLayer(lid2);
        int id3 = data.addVoxel(Color.ORANGE, null, new int[]{1,1,3});
        int id4 = data.addVoxel(Color.WHITE, null, new int[]{1,2,4});
        data.selectLayer(lid2);
        data.addVoxel(Color.BLUE, null, new int[]{1,1,3});
        data.addVoxel(Color.GRAY, null, new int[]{1,2,4});
        ...
        class Util {
            ...
            public void addVoxel() {
                if (data.getSelectedLayer() != -1) {
                    ...
                    int id1 = data.addVoxel(randCol(), null, randPos());
                    if (id1 != -1) {
            ...
            public void massAdd() {
                ...
                for (int i = 0; i < length; i++) {
                    voxel[i] = new Voxel(-1, randPos(), randCol(), false, null, layerId);
                }
