...
import com.vitco.app.layout.content.colorchooser.ColorPaletteChooser;
...
public class ColorPaletteLinkage extends FrameLinkagePrototype {
    ...
    public CDockableFrame buildFrame(String key, final Frame mainFrame) {
        ...
        menuGenerator.buildMenuFromXML(menuPanel, "com/vitco/app/layout/frames/toolbars/colorpalette.xml");
